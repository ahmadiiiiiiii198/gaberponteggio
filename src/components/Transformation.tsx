...
const STAGES = [
  {
    ...
    body: "Facciate segnate dal tempo, intonaci che si sgretolano sotto il cielo dell'Emilia. È da qui che cominciamo: ascoltare la pietra prima di toccarla.",
    ...
    >
      <div className="sticky top-0 h-screen w-full overflow-hidden">
        ...
        <div className="absolute inset-0">
          <img
            src={buildingOld}
            alt="Palazzo storico bolognese in stato di degrado, intonaco scrostato"
          ...
          <img
            ...
            alt="Palazzo storico bolognese restaurato, facciata ocra al tramonto"
            className="absolute inset-0 w-full h-full object-cover will-change-[opacity,transform]"
            style={{
              opacity: newOpacity,
              transform: `scale(${scale}) translateY(${progress * -3}%)`,
