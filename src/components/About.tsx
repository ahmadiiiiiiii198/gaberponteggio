...
export const About = () => {
  return (
    <section id="azienda" className="py-24 md:py-36">
        ...
        <div className="grid md:grid-cols-12 gap-12 items-center">
          <div className="md:col-span-5 flex justify-center">
            <div className="relative w-full max-w-sm aspect-square">
              ...
              <div className="absolute inset-6 bg-background flex items-center justify-center text-primary p-8">
                <Logo className="h-full w-full" />
              </div>
              <div className="absolute -bottom-4 -right-4 bg-accent text-accent-foreground px-3 py-1.5 font-mono text-[10px] uppercase tracking-[0.25em]">
                Est. Torino · 2014
              </div>
            </div>
          </div>
          ...
          <div className="md:col-span-7">
            ...
            <h2 className="font-display text-balance text-4xl md:text-6xl font-medium leading-[0.98] tracking-[-0.03em]">
              Un nome,
              <br />
            ...
            <div className="mt-8 grid sm:grid-cols-2 gap-6 text-sm text-muted-foreground leading-relaxed">
              <p>
            ...
            <div className="mt-10 grid grid-cols-3 border-t border-border pt-6">
              <div>
                <div className="font-display text-3xl md:text-4xl font-medium">CCNL</div>
                <div className="font-mono text-[10px] uppercase tracking-[0.2em] text-muted-foreground mt-1">
                  Edilizia industriale
                </div>
              </div>
              <div>
                <div className="font-display text-3xl md:text-4xl font-medium">DURC</div>
                <div className="font-mono text-[10px] uppercase tracking-[0.2em] text-muted-foreground mt-1">
                  Sempre in regola
                </div>
              </div>
              <div>
                <div className="font-display text-3xl md:text-4xl font-medium">RC</div>
                <div className="font-mono text-[10px] uppercase tracking-[0.2em] text-muted-foreground mt-1">
                  €5M assicurazione
                </div>
              </div>
